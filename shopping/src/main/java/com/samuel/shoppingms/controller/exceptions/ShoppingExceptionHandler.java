...
import com.samuel.shoppingms.services.exceptions.NegocioException;
...
public class ShoppingExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<Object> handleValidationInternal(Exception ex, HttpHeaders headers,
        ...
        List<StandardError.Field> problemFields = bindingResult.getAllErrors().stream()
                .map(objectError -> {
        ...
        StandardError problem = createStandardErrorBuilder(status, problemType, detail)
                .message(detail)
    ...
    private ResponseEntity<Object> handleMethodArgumentTypeMismatch(
        ...
        ErrorType problemType = ErrorType.PARAMETRO_INVALIDO;
